SELECT * FROM DataAnalyticsProject..CovidDeaths$
WHERE continent is not NULL
ORDER BY 3,4


SELECT * FROM DataAnalyticsProject..CovidVaccinations$
WHERE continent is not NULL
ORDER BY 3,4

SELECT location, date, total_cases, new_cases, total_deaths, population
FROM DataAnalyticsProject..CovidDeaths$
ORDER BY 1,2
...
FROM DataAnalyticsProject..CovidDeaths$ cd -- cd=CovidDeaths
JOIN DataAnalyticsProject..CovidVaccinations$ cv --cv=CovidVaccinations
